...
function applyDetachmentRules(player: Combatant, enemy: Combatant): void {
...
if (import.meta.main) {
    ...
    // check detachments
    applyDetachmentRules(player, enemy);
    ...
    // render as percents
    console.log(
        `${player.NAME} (HP: ${player.hp} A${player.RMR} STR: ${player.str} WIL: ${player.WIL} DEX: ${player.DEX} d${player.ATK})`,
    );
    console.log(
